...
//   mutation UpdateCustomerId($orgnaziationId: uuid!, $stripeCustomerId: String!) {
//     updateOrganizationByPk(pk_columns: { id: $orgnaziationId }, _set: { stripeCustomerId: $stripeCustomerId }) {
//       id
//     }
//   }
// `);
